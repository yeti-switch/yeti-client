<template>
  <div id='ratesFilter' class="filter">
    <b-form @submit="onSubmit" @reset="onReset">
      ...
      <b-form-group label="Source prefix routing:">
        <b-form-input v-model="form.srcPrefixRouting" placeholder="Enter source prefix routing" size="sm"/>
      </b-form-group>
      <b-form-group label="Destination prefix routing:">
        <b-form-input v-model="form.dstPrefixRouting" placeholder="Enter destination prefix routing" size="sm"/>
      </b-form-group>
      <b-form-group label="Leg A disconnect code:">
        <b-form-input v-model="form.legaDisconnectCode" placeholder="Enter disconnect code" size="sm"/>
      </b-form-group>
      <b-form-group label="Leg A disconnect reason:">
        <b-form-input v-model="form.legaDisconnectReason" placeholder="Enter disconnect reason" size="sm"/>
      </b-form-group>
      <b-form-group label="Source prefix in:">
        <b-form-input v-model="form.srcPrefixIn" placeholder="Enter source prefix in" size="sm"/>
      </b-form-group>
      <b-form-group label="Destination prefix in:">
        <b-form-input v-model="form.dstPrefixIn" placeholder="Enter destination prefix in" size="sm"/>
      </b-form-group>
      <b-form-group label="Diversion in:">
        <b-form-input v-model="form.diversionIn" placeholder="Enter diversion in" size="sm"/>
      </b-form-group>
      <b-form-group label="Source name in:">
        <b-form-input v-model="form.srcNameIn" placeholder="Enter source name in" size="sm"/>
      </b-form-group>
      <b-form-group label="Local tag:">
        <b-form-input v-model="form.localTag" placeholder="Enter local tag" size="sm"/>
      </b-form-group>
      <b-form-group label="Duration:">
        <b-form-input v-model="form.duration" placeholder="Call duration" size="sm"/>
      </b-form-group>
