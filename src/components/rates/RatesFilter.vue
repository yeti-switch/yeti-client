  ...
  <div id='ratesFilter' class="filter">
    <b-form @submit="onSubmit" @reset="onReset">
      ...
      <b-form-group label="Valid From:">
        <b-form-input v-model="form.validFromGteq" type="date" size="sm"/>
      </b-form-group>

      <b-form-group label="Valid Till:">
        <b-form-input v-model="form.validTillLteq" type="date" size="sm"/>
      </b-form-group>
      <b-form-group label="Prefix:">
        <b-form-input v-model="form.prefixEq" placeholder="Enter prefix" size="sm"/>
      </b-form-group>
      <b-form-group label="Reject Calls:">
        <b-form-select v-model="form.rejectCallsEq" :options="rejectCallsEq" size="sm">Reject Calls</b-form-select>
      </b-form-group>
      <b-form-group label="Enabled:">
        <b-form-select v-model="form.enabledEq" :options="enabledEq" size="sm">Enabled</b-form-select>
      </b-form-group>
